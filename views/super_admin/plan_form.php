                ...
                <form method="POST" class="auth-container" style="max-width: 100%; margin-top: 2rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-input" required
                            value="<?php echo $plan['name'] ?? ''; ?>" placeholder="e.g. Enterprise Tier">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Price (৳)</label>
                        <input type="number" step="0.01" name="price" class="form-input" required
                            value="<?php echo $plan['price'] ?? '0.00'; ?>">
                    </div>

                    <div class="form-group">
                        <label class="form-label">Max Sales Order Limit (Per Month)</label>
                        <input type="number" name="max_sales" class="form-input"
                            value="<?php echo isset($plan) && $plan['max_sales'] != -1 ? $plan['max_sales'] : ''; ?>"
                            placeholder="Leave empty for Unlimited">
                        <small style="color: var(--text-gray);">Enter a number, or leave empty for Unlimited
                            sales.</small>
                    </div>
