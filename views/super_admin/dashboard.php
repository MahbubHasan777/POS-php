                    ...
                    <tbody>
                        ...
                        while ($shop = $res->fetch_assoc()):
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; background: <?php echo $shop['status'] == 'active' ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)'; ?>; color: <?php echo $shop['status'] == 'active' ? '#34d399' : '#f87171'; ?>">
                                        <?php echo ucfirst($shop['status']); ?>
                                    </span>
                                </td>
                                <td><?php echo date('M d, Y', strtotime($shop['created_at'])); ?></td>
                                <td>
                                    <a href="shops.php?edit=<?php echo $shop['id']; ?>"
                                        style="color: var(--primary); text-decoration: none;">Manage</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
