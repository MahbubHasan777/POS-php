    ...
    <div class="dashboard-layout">
        ...
        <div class="main-content">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                ...
                <a href="plan_form.php" class="btn-primary" style="text-decoration: none; width: auto;">+ Create New Plan</a>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="plan_form.php?id=<?php echo $plan['id']; ?>" style="color: var(--primary); margin-right: 1rem; text-decoration: none;">Edit</a>
