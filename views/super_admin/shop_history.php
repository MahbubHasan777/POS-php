                    ...
                    <tbody>
                        <?php if($history->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span style="padding: 0.25rem 0.5rem; border-radius: 0.25rem; background: <?php echo $row['payment_status']=='paid'?'rgba(16, 185, 129, 0.2)':'rgba(239, 68, 68, 0.2)'; ?>; color: <?php echo $row['payment_status']=='paid'?'#34d399':'#f87171'; ?>">
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="text-align: center; color: var(--text-gray); padding: 2rem;">No payment history found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
