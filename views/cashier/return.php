...
<head>
    ...
    <style>
        .container { max-width: 800px; margin: 2rem auto; background: var(--bg-card); padding: 2rem; border-radius: 8px; }
        ...
        .error { color: #ef4444; background: rgba(239, 68, 68, 0.1); padding: 1rem; border-radius: 4px; margin-bottom: 1rem; }
    </style>
</head>
<body>
...
<div class="container">
    <div class="header">
        ...
        <a href="dashboard.php" class="btn-primary" style="text-decoration: none; background: #4b5563;">Back to POS</a>
    </div>

    <form method="GET" style="display: flex; gap: 1rem; margin-bottom: 2rem;">
        <input type="number" name="invoice_id" class="form-input" placeholder="Invoice ID" value="<?php echo htmlspecialchars($invoice_id); ?>" required>
    ...
    <?php if($order_data): ?>
        ...
        <form id="refundForm">
            ...
            <div style="margin-top: 2rem; text-align: right;">
                <button type="button" onclick="processRefund()" class="btn-primary" style="background: #ef4444;">Confirm Refund</button>
            </div>
        </form>
    <?php endif; ?>
</div>
