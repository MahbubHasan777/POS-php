...
<body>
    <div class="dashboard-layout">
        ...
        <div class="main-content">
            <h1>Shop Overview</h1>
            <p style="color: var(--text-gray); margin-bottom: 2rem;">Welcome back,
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <?php if ($low_stock_count > 0): ?>
                        <a href="products.php?filter=low_stock" style="font-size: 0.875rem; color: var(--text-gray);">View
                            Items &rarr;</a>
                    <?php endif; ?>
                </div>
                <div class="stat-card">
                ...
                <div class="stat-card" style="border: 1px solid var(--primary);">
                    ...
                    <div class="stat-value" style="font-size: 1.5rem;">
                        <?php echo $subStats['current_sales']; ?> /
                        <?php echo $subStats['max_sales'] == -1 ? '&infin;' : $subStats['max_sales']; ?> Sales
                    </div>
                    <?php if ($subStats['max_sales'] != -1): ?>
                        <div style="width: 100%; background: #e5e7eb; height: 6px; border-radius: 3px; margin-top: 0.5rem;">
                            <div
                                style="width: <?php echo min(100, ($subStats['current_sales'] / $subStats['max_sales']) * 100); ?>%; background: var(--primary); height: 100%; border-radius: 3px;">
                            </div>
                        </div>
                    <?php endif; ?>
                    <a href="payment.php"
                        style="display: block; margin-top: 0.5rem; color: var(--primary); text-decoration: none; font-weight: 600;">Upgrade
                        / Renew &rarr;</a>
                </div>
            </div>
